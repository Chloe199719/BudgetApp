...
export const post = async (
	...
	try {
		...
		if (res_json["message"]) {
			...
			response = {
				id: res_json["id"] as string,
				email: res_json["email"] as string,
				unique_name: res_json["unique_name"] as string,
				display_name: res_json["display_name"] as string,
				is_staff: res_json["is_staff"] as boolean,
				thumbnail: res_json["thumbnail"] as string,
				is_superuser: res_json["is_superuser"] as boolean,
			};
		}
