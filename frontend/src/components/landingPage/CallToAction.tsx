                ...
                <div className=" p-20  flex -translate-y-10 space-x-64 z-10 max-w-7xl ">
                    <div className=" flex-1 flex flex-col gap-3">
                        ...
                        <h3 className="text-gray-300 text-4xl ml-2">
                            Discover {APP_NAME}, Your Personal Budgeting
                            Assistant!
                        </h3>
                        <ul className="font-bold text-gray-800 text-2xl list-disc mt-5 ml-10">
                            <li>
                                Stay on Track: Effortlessly monitor your
                                spending.
                            </li>
                            <li>
                                Save Smartly: Set goals and watch your savings
                                grow.
                            </li>
                            <li>
                                Gain Insights: Understand your habits with
                                easy-to-read charts.
                            </li>
                            <li>
                                Secure & Private: Your data stays safe with us.
                            </li>
                        </ul>
